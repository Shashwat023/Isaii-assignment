...
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const apiBaseUrl = ("TURBOPACK compile-time value", "http://localhost:5000");
            const loginUrl = `${("TURBOPACK compile-time truthy", 1) ? apiBaseUrl.replace(/\/+$/, "") : "TURBOPACK unreachable"}/api/auth/login`;
...
_s(LoginForm, "HkstlZxBP401W7mEyXecD2QXLSE=", false, function() {
    return [
...
//# sourceMappingURL=_ceeba380._.js.map